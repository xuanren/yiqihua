...
//    }else [self.iconImgView setImage:nil];
    ...
    if ([colleage.imgs count] > 0){
        ...
        NSURL *imgUrl = [NSURL URLWithString:[[ROOTURL stringByAppendingString:IMGURL]stringByAppendingString:[tmpDic objectForKey:@"id"]]];
        
        [self.iconImgView setImageWithURL:imgUrl  placeholderImage:nil];
    }
    self.titleLabel.text = [NSString stringWithFormat:@"%@",colleage.colleageLevel];
