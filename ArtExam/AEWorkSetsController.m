...
@property (nonatomic, retain) NSString *selectTypeId;
...
- (void)viewDidLoad
{
   ...
   // [gmGridView reloadData];
    ...
    self.workSetList.myType = AETopicALL;
    self.workSetList.allTypeId = self.selectTypeId;
...
{
    double cellCount = [self.workSetList.workSetArrClassify count];
    return cellCount;
}
...
- (GMGridViewCell *)GMGridView:(GMGridView *)gridView cellForItemAtIndex:(NSInteger)index
{
    ...
    [((AEWorkSetGridCell *)cell)configureWithWorkSet:[self.workSetList.workSetArrClassify objectAtIndex:index]];
    return cell;
}
...
{
    AEWorkSet *tmp = (AEWorkSet *)[self.workSetList.workSetArrClassify objectAtIndex:position];
