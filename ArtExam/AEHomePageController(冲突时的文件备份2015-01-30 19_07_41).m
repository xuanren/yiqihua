...
- (void)initNavItem{
    [super initNavItem];
    self.navigationItem.title = @"ART TOGETHER";
}
...
- (void)viewDidLoad
{
   ...
   // [self addNavigationRightItem];
    ...
    self.pullTableView.pullBackgroundColor = [UIColor colorWithRed:240.0/255.0 green:240.0/255.0 blue:240.0/255.0 alpha:1];
