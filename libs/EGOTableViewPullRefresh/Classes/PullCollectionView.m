...
@synthesize pullCollectionDelegate;
...
- (void)configDisplayProperties
{
    [refreshView setBackgroundColor:[UIColor redColor]];
...
{
    pullTableIsRefreshing = YES;
    [pullCollectionDelegate pullCollectionViewDidTriggerRefresh:self];
}
...
{
    pullTableIsLoadingMore = YES;
    [pullCollectionDelegate pullCollectionViewDidTriggerLoadMore:self];
}
@end
